...
export const MainBanner: React.FC<MainBannerProps> = ({
  ...
  return (
    <div className="relative h-[800px] w-full sm:h-[400px] md:h-[500px] xl:h-[650px]">
      ...
      <div className="absolute right-[-0.5rem] top-1/2 max-w-lg -translate-y-1/2 transform rounded-[20px] bg-[#bf3a2b]/10 p-10 backdrop-blur-[41px] sm:max-w-xs sm:p-6 md:max-w-md md:p-8 lg:right-10">
